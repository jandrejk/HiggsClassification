...
"""
rivetHTXSTable = cms.EDProducer("HTXSflatTableProducer",
    src = cms.InputTag("HiggsClassification"),
    ...
    #cut = cms.string(""),
    variables = cms.PSet(
       HiggsClassification = Var("stage1_cat_pTjet30GeV", float, precision=10)
       #fiducialGenPt  = Var("pt",  float, precision=10),
       #fiducialGenPhi = Var("phi", float, precision=10),
    ),
)
